    ...
    return  <div className="payment__recive" >
                ...
                <div className="payment__recive-content">
                    <div className='method-content__subdistrict' >
                        ...
                        <input type="text" id='name' className='method-content__address-number' required placeholder='Ví dụ: Nguyễn Văn A'/>
                    </div>
                    <div className='method-content__subdistrict' >
                        <div className='method-label'>Số điện thoại: </div>
                        <input type="text" id='phone' className='method-content__address-number' required placeholder='0123456789'/>
                    </div>
                    <div className='method-content__subdistrict' >
                        <div className='method-label'>Email: </div>
                        <input type="text" id='email' className='method-content__address-number' required placeholder='email@gmail.com'/>
                    </div>
                </div>
            </div>
}
